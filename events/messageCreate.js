        ...
        if (message.guild) {
            ...
            if (!channel) {
                ...
                const sent = await message.reply({
                    content: `You\'re about to create a new Ticket with the details from the replied message, are you sure about that?\nYou have 15 seconds to select one of the buttons below. (${time(Date.now() + 15000, 'R')})`,
                    components: [
                            ...
                            await sent.edit({
                                ...
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription('Thank you for creating a new Ticket, Our support Team should respond to your ticket any time soon!')
